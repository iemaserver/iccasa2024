  ...
  return (
    <div className="flex flex-col lg:py-28 py-8 container mx-auto">
      <div>
              ...
              <Tbody>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    ...
                    Geology, Physics and Inorganic Chemistry, Rey Juan Carlos
                    University, Spain
                  </Td>
                </Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Associate Professor, Amity Institute of Information
                    Technology, Amity University Rajasthan, Jaipur-303002, India
                  </Td>
                </Tr>
                <Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Assistant Professor, Division of Dynamics Lodz University of
                    technology, Lodz, Stefanowskiego
                  </Td>
                </Tr>
                <Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Assistant Professor, Department of Physics, Dyal Singh
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Assistant Professor, Department of Mathematical and Physical
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    ...
                    Research Institute (CGCRI), Kolkata, India.
                  </Td>
                </Tr>
                <Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    ...
                    Building, MJP Rohilkhand University Bareilly, Utter Pradesh,
                    India.{" "}
                  </Td>
                </Tr>
                <Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Retd. Professor, Department of Mathematics, University of
                    Rajasthan Jaipur, Jaipur, Rajasthan, India.{" "}
                  </Td>
                </Tr>
                <Tr>
                ...
                <Tr>
                  <Td className="text-lg font-bold">
                    Prof. (Dr.) Prashant S. Alegaonkar
                  </Td>
                  <Td className=" font-semibold">
                    Department of Physics, School of Basic Sciences, Central
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Associate Professor, Department of Mathematics, MNIT Jaipur,
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Associate Professor, Department of Mathematics, IIT Patna,
                    Bihar, India.{" "}
                  </Td>
                </Tr>
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Associate Professor and Head of Department Mathematics, NIT
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Associate Professor and Head of Department Mathematics SMPG
                    College, Meerut, Utter Pradesh, India.{" "}
                  </Td>
                </Tr>
                <Tr>
                  <Td className="text-lg font-bold">Dr. Vipin Kumar</Td>
                  <Td className=" font-semibold">
                    Associate Professor, Department of Mathematics B K Birla
                    Institute of Engineering and Technology, Pilani, Rajasthan,
                    India.{" "}
                  </Td>
                </Tr>
              </Tbody>
        ...
        <h1 className="text-lg lg:text-5xl font-bold mt-6 mb-4 lg:mb-10 lg:mt-24 2xl:mb-16">
          Think Tank
        </h1>
      </div>
      ...
      <div>
        ...
        <div className="border border-gray-300 rounded-lg p-4">
          <TableContainer className="mb-4 responsiveTable">
            <Table>
              <Tbody>
                <Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Associate Professor(Department of Mathematics) UEM Jaipur
                  </Td>
                </Tr>
              </Tbody>
            </Table>
            ...
            <Table>
              <Tbody>
                <Tr>
                  ...
                  <Td className="font-semibold">
                    Associate Professor(Department of Physics) UEM Jaipur.
                  </Td>
                </Tr>
              </Tbody>
            </Table>
        ...
        <h1 className="text-lg lg:text-3xl font-bold mb-4 mt-6">
          Organising Team
        </h1>
        <div className="border border-gray-300 rounded-lg p-4">
          <TableContainer className="mb-4 responsiveTable">
            <Table>
              <Tbody>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Associate Professor(Department of Chemistry) UEM Jaipur
                  </Td>
                </Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Lab Technician(Department of Physics) UEM Jaipur
                  </Td>
                </Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Lab Techinician(Department of Chemistry) UEM Jaipur
                  </Td>
                </Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Research Scholar(Department of Mathematics) UEM Jaipur
                  </Td>
                </Tr>
                ...
                <Tr>
                  ...
                  <Td className=" font-semibold">
                    Research Scholar(Department of Chemistry) UEM Jaipur
                  </Td>
                </Tr>

                <Tr>
                  <Td className="text-lg font-bold">
                    Ms. Santosh kumari Bajiya
                  </Td>
                  <Td className=" font-semibold">
                    Research Scholar(Department of Chemistry) UEM Jaipur
                  </Td>
        ...
        <h1 className="text-lg lg:text-3xl font-bold mb-4 mt-6">
          Technical and other Support Team
        </h1>
        <div className="border border-gray-300 rounded-lg p-4">
          <TableContainer className="responsiveTable">
            <Table>
