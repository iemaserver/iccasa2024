    ...
    <div
      className="flex flex-col container mx-auto xl:py-32 lg:py-16 py-8">
          ...
          <p className="mt-4 font-semibold text-sm lg:text-xl">The conference revolves around bringing mathematics, physics and chemistry research areas synchronically on an indivisible 
            ...
            with their peers and counterparts. They will also have the chance to meet experts and high-level delegates, along with share 
            ideas and research findings from past and present. Participants can build new networks to meet different personalities and learn 
